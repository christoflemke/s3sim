...
const mockedMethods = {
  ...
  getObject: async ({ Key, Bucket }) => {
    const file = getObject(Bucket, Key)
  ...
  putObjectTagging: async (opts) => {
    const s3Object = getObject(opts.Bucket, opts.Key)
    const s3Version = opts.VersionId ? s3Object.versions.find(v => v.VersionId === opts.VersionId) : s3Object.versions[0]
    if (!s3Version) {
